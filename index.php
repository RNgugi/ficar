...
<body>
        ...
        <div class="container">
            <div class="row fullscreen d-flex align-items-center justify-content-start">
                <div class="banner-content col-lg-8 col-md-12">
                    ...
                    <a href="#" class="primary-btn header-btn text-uppercase">More About Us</a>
                </div>
            </div>
        </div>
    </section>
	...
	<!-- Start team Area -->
    <section class="team-area section-gap" id="chefs" style="padding-top:5%; padding-bottom:5%">
        <div class="container">
            <div class="row d-flex justify-content-center">
                <div class="menu-content pb-70 col-lg-8">
                    <div class="title text-center">
                        <h1 class="mb-10">Our Hotels</h1>
                        <p>Below are all our partner Hotels</p>
                    </div>
                </div>
            </div>
            <div class="row">
...
<?php
                    ...
                    if (mysqli_num_rows($result) > 0) 
                    {
                        ...
                        {
                ?>
                    <div class="single-dish col-md-4">
                            <center>
                                <div class="thumb">
                                <a href="single/index.php?hid=<?php echo $row["Customer_name"]; ?>">
                                        <img class="img-fluid" src="<?php echo $row["photo"]; ?>" style="background-size: cover; height: 250px; width: 280px;"/>
                                    </a>
                                    <h4 class="text-uppercase pt-20 pb-20"><?php echo $row["Customer_name"]; ?></h4>
                                </div>
                            </center>
                        </div>
                ...
                <!-- @foreach (user usr in ViewBag.ListUsers)
                {
                    if (usr.Access_level == 2)
                    {
                        ...
                        <div class="single-dish col-md-4">
                            <center>
                                <div class="thumb">
                                    <a href='@Url.Action("Index", "Single", new {id = @usr.Customer_name})'>
                                        <img class="img-fluid" src="@Url.Content(usr.photo)" style="background-size: cover; height: 250px; width: 280px;"/>
                                    </a>
                                    <h4 class="text-uppercase pt-20 pb-20">@usr.Customer_name</h4>
                                </div>
                            </center>
                        </div>
                    }
    ...
    <!-- Start related Area -->
    <section class="related-area section-gap" style="padding-top:5%; padding-bottom:5%">
        <div class="container">
            <div class="row d-flex justify-content-center">
                <div class="menu-content pb-60 col-lg-8">
                    <div class="title text-center">
	...
	<!-- Start features Area -->
    <section class="features-area pt-100" id="feature" style="padding-top:2%; background-color:#f9f9ff">
        <div class="container">
            <div class="row d-flex justify-content-center">
                <div class="menu-content pb-60 col-lg-8">
                    <div class="title text-center">
                        <h1 class="mb-10">Our Services</h1>
                        <p>Some of our amazing services</p>
                    </div>
                </div>
            </div>
    ...
    <!-- start blog Area -->
    <!-- <section class="blog-area section-gap" id="blog" style="padding-top:5%; padding-bottom:5%">
        <div class="container">
            <div class="row d-flex justify-content-center">
                <div class="menu-content pb-70 col-lg-8">
                    <div class="title text-center">
    ...
    <!-- end blog Area -->
    <!-- Start Contact Area -->
    <div class="row d-flex justify-content-center" style="padding-top:3.5%;">
        <div class="menu-content pb-70 col-lg-8" style="padding-bottom:0px">
            <div class="title text-center">
                <h1 class="mb-10">Contact Us</h1>
                <p>Drop us a line or drop by for a cup of coffee!</p>
            </div>
        </div>
    </div>
    <section class="contact-area" id="contact" style="padding-top:0px">
        <div class="container-fluid">
            <div class="row align-items-center d-flex justify-content-start">
                <div class="col-lg-6 col-md-12 contact-left no-padding">
                    <div style=" width:100%;
	                height: 350px;" id="map"></div>
                </div>
